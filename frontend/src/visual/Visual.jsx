...
const Visual = () => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-lg w-3/4 overflow-hidden pb-8">
            <div className="max-h-56 w-full relative cursor-pointer overflow-hidden group">
                <img className="object-cover w-full max-h-56 group-hover:scale-105 transition-transform duration-200" src={images['Cover Photo']} />
                <div
            ...
            >
                ...
                <div className="size-full rounded-full overflow-hidden">
                    <img className="object-cover rounded-full size-full group-hover:scale-105 transition-transform duration-200" src={images['Profile Picture']} />
                </div>
            </div>
